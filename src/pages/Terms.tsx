         ...
         <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
           <section>
             ...
             <p className="text-muted-foreground leading-relaxed">
              By accessing or using the Build AI platform and services provided by Build AI, LLC ("Company," "we," "us," or "our"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use our services.
             </p>
           </section>
           ...
           <section>
             ...
             <p className="text-muted-foreground leading-relaxed">
              Build AI is an AI-powered product intelligence platform that helps product teams analyze customer feedback, usage data, and market signals to prioritize features and make data-driven roadmap decisions. The service is provided on a subscription basis as Software-as-a-Service (SaaS).
             </p>
           </section>
           ...
           <section>
             ...
             <p className="text-muted-foreground leading-relaxed">
              All intellectual property rights in the service, including software, algorithms, designs, trademarks, and documentation, are owned by Build AI, LLC or our licensors. These Terms do not grant you any rights to use our trademarks or branding without prior written consent.
             </p>
           </section>
           ...
           <section>
             ...
             <p className="text-muted-foreground leading-relaxed">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, BUILD AI, LLC SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, REVENUE, DATA, OR USE, ARISING OUT OF OR RELATED TO THESE TERMS OR THE SERVICES. OUR TOTAL LIABILITY SHALL NOT EXCEED THE AMOUNT PAID BY YOU TO US IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM.
             </p>
           </section>
           ...
           <section>
             ...
             <div className="mt-4 p-4 rounded-lg bg-muted/50 border border-border">
              ...
              <p className="text-muted-foreground">Email: legal@buildai.co</p>
             </div>
           </section>
         </div>
       </main>
